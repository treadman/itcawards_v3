...
<cfelse>
	<span class="pagetitle">Division Office Update for <cfoutput>#request.program_name#</cfoutput></span><br><br>
	<cfset errors1 = "">
	<cfset errors2 = "">
	<cfset errors3 = "">
	<cfset errors4 = "">
	...
	<!--- Saved using Macbook has only chr(13), so no chr(10) below --->
	<cfset thisData = Replace(thisData,"#CHR(13)#","|","ALL")>
